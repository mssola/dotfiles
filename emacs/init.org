...
Another important package is =flycheck=, which is a on-the-fly syntax checking
...
Finally, we have =expand-region=. This is an extension that is based on a Vim
...
Forgive me, [[https://stallman.org/saint.html][Father]], for I have sinned. As I said in the [[:preface][Preface]], I've been
